...
-   The price of the diamond tends to go up as the carat number
    increases.

    -   The median price rises across the carat

-   The median price is around the same for cuts 2.5 to 4.5

    -   Shown by the bar on the graph.
