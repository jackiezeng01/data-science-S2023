...
- Document your observations here.
  - For 12/14 counties, 2-person families have a smaller confidence
    interval than that of 6-person families.
  - Typically, if there are more people in the family, the household
    earns more. But this is not true for all the data
  - For less populous counties such as Nantucket and Dukes, the
    confidence interval is larger
- Can you confidently distinguish between household incomes in Suffolk
  county? Why or why not?
  - Not really because the points are really close together and
    overlapping
...
My question is how does race affect median income in the United States.
...
df_q8 <-
  ...
  mutate(across(matches("HOUSEHOLD INCOME BY RACE AND HISPANIC OR LATINO ORIGIN OF HOUSEHOLDER"), as.numeric)) %>%
## TODO: Pivot the data, rename the columns
  pivot_longer(
...
```
    ...
    ## Warning: Removed 17585 rows containing non-finite values (`stat_boxplot()`).

![](c09-income-assignment_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->

**Observations**:

- Across the united states, Asian and Native Hawaiian and Other Pacific
  Islander had the highest median income_estimate. However, they also
  have a wider 25 to 75 percentile range.
- Black or African American have the lowest median income estimate
