...
-   Is there "one true value" for the material properties of Aluminum?
    -   No, the material properties of Aluminum depends on several properties: E, nu, alloy, angle, and thickness
-   How many aluminum alloys are in this dataset? How do you know?
    -   There is only one type of alloy: al_24st. I know this because I performed the dplyr function distinct() on each column.
...
-   There seems to be no discernible effect of thickness on the value of elasticity .
...
-   Does this graph support or contradict the claim above?
    -   The graph contradicts this claim. For the thickest sample at 0.081, the E and nu values are smaller than that of the thinner samples.
