...
-   Based on these missing variables, what possible effects could be
    ...
    -   Whether there is any correlation with particular score trends
        and demographic and economic background
...
-   What relationship do `univ_GPA` and `both_SAT` exhibit?
    -   There is a positive correlation between university GPA and
        rising SAT scores
...
-   Which correlations are significantly nonzero?
    -   Both of these correlations are statistically significant as the
...
-   How do the results here compare with the visual you created in q2?
    -   It matches. high_GPA's visual in q2 had a steeper slope, which
        reflects the higher correlation estimate we got from this
        question.
...
-   How does your estimate from q5 compare with your estimate from q4?
    -   The estimate from q5 (0.7834) is higher than that of q4
        (0.6846776)
...
-   By itself, how well does `both_SAT` predict `univ_GPA`?
    -   the p value is 1.081652e-11, so I think it predits univ_GPA
        quite well
...
-   What is the confidence interval on the coefficient of `both_SAT`
    ...
    -   the estimate is 0.0005339463, which is not very different than
        zero
