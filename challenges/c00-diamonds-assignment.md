...
- There is a positive correlation between the number of carats and the
...
- It seems like even if the diamonds are not high carat, as long as they
  are a high quality cut, they can fetch a good price. This is supported
  by the lighter color (ideal) at the top left and the darker color
  (fair) at the bottom right.
